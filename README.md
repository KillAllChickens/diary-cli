...
- **TUI & Neovim Integration**: Simple TUI for selecting and interacting with your past entries, seamlessly dropping you into your `$EDITOR` (defaults to Neovim).
- **Markdown & Frontmatter**: Parses YAML frontmatter for tags, mood, and weather. Renders markdown directly in your terminal.
